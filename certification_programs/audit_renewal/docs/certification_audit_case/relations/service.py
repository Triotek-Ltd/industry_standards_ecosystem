"""Relation service seed for certification_audit_case."""
...
RELATED_DOCS = [{'doc_id': 'certification_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'certification_renewal', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'audit_engagement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'certification identity'}, {'description': 'scope from certification_record'}]
