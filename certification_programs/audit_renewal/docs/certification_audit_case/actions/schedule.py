"""Action handler seed for certification_audit_case:schedule."""
...
ACTION_ID = "schedule"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'scheduled', 'in_progress', 'completed'], 'transitions_to': None}
