...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['certification_record', 'certification_renewal', 'audit_engagement'], 'action_targets': {'create': None, 'schedule': None, 'assign': 'in_progress', 'complete': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
