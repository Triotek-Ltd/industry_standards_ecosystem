"""Action handler seed for certification_renewal:prepare."""
...
ACTION_ID = "prepare"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['prepared', 'submitted', 'approved', 'rejected', 'renewed'], 'transitions_to': None}
