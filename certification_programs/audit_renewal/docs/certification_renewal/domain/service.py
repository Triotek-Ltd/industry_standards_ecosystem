...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['certification_record', 'certification_audit_case'], 'action_targets': {'create': None, 'prepare': None, 'submit': 'submitted', 'approve': 'approved', 'reject': 'rejected', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
