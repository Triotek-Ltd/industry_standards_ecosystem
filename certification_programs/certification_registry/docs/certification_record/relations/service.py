"""Relation service seed for certification_record."""
...
RELATED_DOCS = [{'doc_id': 'certification_audit_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'certification_renewal', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'standards_adoption_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'certification-program context from standards/adoption docs where linked'}]
