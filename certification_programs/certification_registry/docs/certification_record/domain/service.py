"""Business-domain service seed for Certification Record."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['certification_audit_case', 'certification_renewal', 'standards_adoption_case'], 'action_targets': {'create': None, 'update': None, 'renew': None, 'suspend': None, 'archive': 'archived'}, 'action_side_effects_file': None}
