...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['standards_adoption_case', 'control_mapping_record', 'policy_document'], 'action_targets': {'create': None, 'update': None, 'review': None, 'activate': 'active', 'retire': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
