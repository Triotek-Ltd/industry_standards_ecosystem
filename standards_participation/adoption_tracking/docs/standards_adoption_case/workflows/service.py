"""Workflow service seed for standards_adoption_case."""
...
STATES = ['opened', 'in_progress', 'implemented', 'deferred', 'closed', 'archived']
TERMINAL_STATES = ['closed', 'archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': None}, 'assign': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': 'in_progress'}, 'implement': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': None}, 'defer': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': None}, 'close': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['opened', 'in_progress', 'implemented', 'deferred'], 'transitions_to': 'archived'}}
