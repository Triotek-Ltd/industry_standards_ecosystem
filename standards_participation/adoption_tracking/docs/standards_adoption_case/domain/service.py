...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['standards_requirement', 'control_mapping_record', 'certification_record'], 'action_targets': {'create': None, 'assign': 'in_progress', 'implement': None, 'defer': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
