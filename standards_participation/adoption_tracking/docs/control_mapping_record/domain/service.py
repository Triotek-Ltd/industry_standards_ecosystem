...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['standards_requirement', 'standards_adoption_case', 'policy_document', 'compliance_record'], 'action_targets': {'create': None, 'review': 'reviewed', 'confirm': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
