...
RELATED_DOCS = [{'doc_id': 'association_membership', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'participation_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'government_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'membership identity'}, {'description': 'dates from association_membership'}]
