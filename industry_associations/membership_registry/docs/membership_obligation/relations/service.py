"""Relation service seed for membership_obligation."""
...
RELATED_DOCS = [{'doc_id': 'association_membership', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'participation_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'government_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'membership identity'}, {'description': 'dates from association_membership'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
