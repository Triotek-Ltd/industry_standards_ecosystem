"""Relation service seed for association_membership."""
...
RELATED_DOCS = [{'doc_id': 'membership_obligation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'participation_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'association/program context from external reference data where linked'}]
