...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['membership_obligation', 'participation_event'], 'action_targets': {'create': None, 'update': None, 'renew': None, 'suspend': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
