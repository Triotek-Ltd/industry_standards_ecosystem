"""Relation service seed for participation_event."""
...
RELATED_DOCS = [{'doc_id': 'association_membership', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'membership_obligation', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'membership identity from association_membership'}]
