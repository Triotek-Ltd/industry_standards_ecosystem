"""Workflow service seed for participation_event."""
...
STATES = ['planned', 'completed', 'archived']
TERMINAL_STATES = ['archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['planned', 'completed'], 'transitions_to': None}, 'schedule': {'allowed_in_states': ['planned', 'completed'], 'transitions_to': None}, 'complete': {'allowed_in_states': ['planned', 'completed'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['planned', 'completed'], 'transitions_to': 'archived'}}
